...
public class ProxyActivity extends Activity {
    ...
    public static final String Proxy_Service = "com.ryg.dynamicloadhost.ProxyService";
    ...
    protected void launchTargetActivity(final String className) {
        ...
        try {
            ...
            Method setProxy = localClass.getMethod("setProxy", new Class[] { Activity.class, String.class, String.class });
            setProxy.setAccessible(true);
            setProxy.invoke(instance, new Object[] { this, Proxy_Service, mDexPath });
    ...
    protected void instantiateLifecircleMethods(Class<?> localClass) {
        ...
        try {
        	onCreateOptionsMenu = localClass.getDeclaredMethod("onCreateOptionsMenu",
                    new Class[] { Menu.class });
        	onCreateOptionsMenu.setAccessible(true);
        } catch (NoSuchMethodException e) {
            e.printStackTrace();
        }
        mActivityLifecircleMethods.put("onCreateOptionsMenu", onCreateOptionsMenu);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
    	Method onCreateOptionsMenu = mActivityLifecircleMethods.get("onCreateOptionsMenu");
    	if(onCreateOptionsMenu != null) {
    		try {
    			return (Boolean)onCreateOptionsMenu.invoke(mRemoteActivity, menu);
            } catch (Exception e) {
                e.printStackTrace();
                return false;
            }
